...
\def\KUTporadoveCislo{dev250724}
...
\begin{center}
	...
	\figcaption{Rozmiestnenie počítačov s meracími kartami v miestnosti D328} 
	\label{D328map_v1}
...
% \section{Pracoviská pre predmet Modelovanie a riadenie systémov}

% Na nasledujúcom obrázku je zobrazené rozmiestnenie laboratórnych zariadení v~miestnosti D328.

% \begin{center}

%     \makebox[\textwidth][c]{%
%     \input{../SVG/D328map_v0.pdf_tex}
%     }
