...
\def\KUTporadoveCislo{devMOTOR\_part2}
...
\begin{flushleft}
    Laboratórne zariadenie mot\_UNO\_mk2:\\ Statické vlastnosti
\end{flushleft}
...
textu je opis laboratórneho zariadenia mot\_UNO\_mk2 z hľadiska jeho statických vlastností.
