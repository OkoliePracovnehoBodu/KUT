...
\noindent
\input{../PY/latex-dirtree-gen-output/dirTree_ML.tex}

\medskip

\noindent
Verzia MATLAB 22b bola použitá na vytvorenie uvedených schém.
...
\subsection{Zariadenie TS02, schéma \texttt{TS02\_start.slx}}

Zariadenie \textsf{TS\textl{02}} je pripojené k počítačovej zostave \textsf{LK\textl{32}}. Zodpovedajúca Simulink schéma je \texttt{TS02\_start.slx}. Opis schémy je analogický ako v predchádzajúcej časti.
