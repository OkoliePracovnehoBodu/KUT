...
Skript pre výpočty a obrázky, ktoré sú uvedené v texte vyššie, je v súbore \texttt{job\_computations.ipynb} v podadresári \texttt{PY}. Adresárová štruktúra všetkých dátových súborov, obrázkov a skriptov prislúchajúcich k tomuto textu je nasledovná:
