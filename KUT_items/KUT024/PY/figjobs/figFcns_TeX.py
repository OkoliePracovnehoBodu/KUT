...
def fcn_setFigStyle_basicTimeSeries_var1(fig, figPlotParam, XYT_labels):
    ...
    for ax in fig.get_axes():
        ...
        ax.yaxis.set_major_locator(MultipleLocator(20, offset=0))
...
def fcn_setFigStyle_basicTimeSeries_var2(fig, figPlotParam, XYT_labels):
